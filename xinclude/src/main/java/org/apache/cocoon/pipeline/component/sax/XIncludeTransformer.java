...
public final class XIncludeTransformer implements SAXConsumer {
	...
	/**
	 * Eventually previous errors don't reset local variables status, so every time
	 * a new consumer is set, local variables should be re-initialized
	 */
	...
	/**
	 * Determine whether the pipe is currently in a state where contents should be
	 * evaluated, i.e. xi:include elements should be resolved and elements in other
	 * namespaces should be copied through. Will return false for fallback contents
	 * within a successful xi:include, and true for contents outside any xi:include
	 * or within an xi:fallback for an unsuccessful xi:include.
	 */
	...
	private void processXIncludeElement(String href, String parse, String xpointer, String encoding, String accept,
		...
		// An empty or absent href is a reference to the current document -- this can be
		// different than the current base
