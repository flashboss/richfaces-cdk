...
public class AptSourceUtilsAnnotationsTest extends SourceUtilsTestBase {
	...
	public void testIsAnnotationPresent() {
		execute(new SourceUtilsCallback() {
			...
			public void process(SourceUtils utils, RoundEnvironment roundEnv) {
				assertTrue(
						utils.isAnnotationPresent(findElement(roundEnv, ANNOTATIONS_TEST_CLASS), TestAnnotation.class));
			}
		});
	}
	...
	public <T> void getAndCompareAnnotationValue(final String propertyName, final Class<T> type,
	...
	public <T> void getAndCompareAnnotationValues(final String propertyName, final Class<T> type,
			final Object... expected) {
		execute(new SourceUtilsCallback() {
			@Override
			public void process(SourceUtils utils, RoundEnvironment roundEnv) {
	...
	public void testGetClassAnnotationValues() {
		getAndCompareAnnotationValues("types", ClassName.class, ClassName.get(String.class),
